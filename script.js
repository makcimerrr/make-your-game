...
clickSound.src = "../audio/shotgun.mp3";
clickSound.preload = "auto";

var hitmarker = new Audio();
hitmarker.src = "../audio/HitMarker+shot.mp3";
hitmarker.preload = "auto";
...
document.addEventListener("click", function (event) {
  // Check if the clicked element is not a bird
